...
Nota: el término “sobreprecio” utilizado a lo largo del informe e insights, hace referencia a la diferencia de precio observada entre versiones, la cual puede estar influenciada por factores como ingredientes, marca y posicionamiento.

- Las fechas de lanzamientos que van desde diciembre del 2024 hasta febrero del 2026 coinciden con los picos más altos de fuerza de tendencia, tal como podemos ver en el gráfico de tendencia semanal. Esto podría estar respondiendo por qué las marcas se suben a estas tendencias.
...
- En cuanto a los costos se observa que las marcas artesanales que forman parte del proyecto (Cacao Sampaka y El Beato) tienen un precio elevado pero respetan una relación favorable en cuanto a los porcentajes de ingredientes importantes que contienen. Si hablamos de Lindt, es una marca cuyo precio presenta una menor relación directa con sus ingredientes, donde el peso de marca tiene una influencia relevante. Por último, en las dos marcas restantes, vemos que Hacendado presenta una relación calidad-precio más favorable y, en contraste, Temptation presenta un precio bajo acompañado de un bajo porcentaje de ingredientes clave, lo que impacta en nuestra comparativa. Cabe aclarar que los valores de esta última marca fueron tomados bajo este criterio: “En cuanto al porcentaje de sus ingredientes posee pasta de pistacho con un 27% sobre el 50% que comprende el relleno sobre el total de la tableta de chocolate pero no fue tenido en cuenta porque no decía cuánto de esa pasta era de pistacho puro, solo tuve en cuenta la medida de pistacho tostado troceado de 4,5% sobre el 50% que comprende el relleno del total de la tableta de chocolate.” que mencionamos al principio de este trabajo. Esto introduce cierta incertidumbre en la interpretación por falta de claridad en la distribución de sus ingredientes.
- La diferencia de precio observada explica la brecha que hay entre la versión clásica y el estilo Dubai de la misma marca. El promedio de las cinco marcas es de 73,46%. Hacendado, fiel a lo que viene mostrando, tiene la diferencia más baja; cabe recordar, como aclaramos antes, que su comparativa fue con un producto de la misma marca Hacendado Fussion, el cual era relleno de galleta caramelizada, lo que puede explicar que la brecha sea más corta entre los precios. A su vez, Temptation fue comparado con una versión clásica que contenía almendras enteras, lo cual rompe la referencia de un producto más estándar. Aun así, vemos que presenta una diferencia de precio en su versión Dubai de 171,82%. Esta sección de costos y diferencia de precio deja indicios de un efecto asociado al hype generado en torno a la versión estilo Dubai, que podría influir en la disposición a pagar un precio más elevado que otras versiones. También se puede considerar este punto en el contexto de la fuerte viralización en redes sociales que impulsó este fenómeno.
...
Cabe recalcar que durante la investigación se observaron distintos productos, los cuales no eran tabletas de chocolates, pero sí lanzaron al mercado su versión Dubai. Al observar sus ingredientes nos damos cuenta que se alejan de la receta original, pero de todas formas logran posicionarse y tener una porción del mercado gracias a lo que genera en el consumidor elegir lo que todo el mundo consume en estos momentos, versión “estilo Dubai”.
